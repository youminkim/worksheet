                ...
                <tr>
                    ...
                    <td>
                        <Stack distribution="trailing">
                            <DisplayText size="medium"> {a} </DisplayText>
                        </Stack>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <Stack distribution="trailing">
                            <DisplayText size="medium"> {b} </DisplayText>
                        </Stack>
                    </td>
                </tr>
            </table>
...
export default function Home() {
    ...
    const handleStartChange = useCallback((s) => {
        if (Number(s) >= 0) setStart(s);
    });
    const handleEndChange = useCallback((s) => {
        if (Number(s) >= 0) setEnd(s);
    });
    ...
    const problems = Array(Number(quantity))
        .fill()
        .map((_, i) => {
            const columns = Array(Number(cols))
                .fill()
                .map((_, i) => {
                    return (
                        <Problem
                            {...{ operation, start, end, carry, negative }}
                        />
                    );
                });
            return (
    ...
    const github = (
        <a href="https://github.com/youminkim/wotksheet">
            <svg
    ...
    return (
        <Page
            ...
            titleMetadata={
                <span>
                    <a href="/99">9x9 table</a> | <u>worksheet.now.sh</u>
                </span>
            }
        >
